...
<div class="mb-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center space-x-3">
            <button onclick="refreshStats()" class="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-lg hover:bg-blue-200 transition-colors">
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <select id="paymentFilter" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <tr class="order-row" 
                        ...
                        <td data-label="Order ID">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="text-sm font-bold text-gray-900 searchable-id">#{{ $order->id }}</p>
                        ...
                        <td data-label="Customer">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-gray-900 searchable-name">{{ $order->user->name ?? 'Guest' }}</p>
                                    <p class="text-xs text-gray-500 searchable-email">{{ $order->user->email ?? 'No email' }}</p>
                                </div>
                            </div>
                        </td>
                        <td data-label="Items">
                        ...
                        <td data-label="Actions">
                            <div class="flex items-center space-x-2">
                                ...
                                <form action="{{ route('admin.order.delete', ['id' => $order->id]) }}" method="post"
                                      onsubmit="return confirm('Are you sure you want to delete this order? This action cannot be undone.');" class="inline">
                                    @csrf
                                    @method('delete')
